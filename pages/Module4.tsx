...
const contentData: Record<number, { title: string, objective: string, content: string[] }> = {
  [UserLevel.PRESCRIPTOR]: {
    title: "Cómo explicar RedesComerciales.ai",
    objective: "Aprender a comunicar el valor del ecosistema de forma clara, honesta y profesional.",
    content: [
      "El colaborador explica el valor de RedesComerciales.ai de forma clara y honesta, sin entrar en detalles técnicos complejos.",
      "Mensaje clave: 'RedesComerciales.ai es un ecosistema tecnológico que ayuda a empresas a transformar sus colaboradores en una red de ventas activa'.",
      "Es vital aclarar que RedesComerciales.ai facilita el crecimiento a través de tecnología y acompañamiento experto.",
      "Recuerda: El colaborador no negocia precios ni condiciones comerciales. Su función es detectar oportunidades y explicar el valor."
    ]
  },
...
const quizData: Record<number, { title: string, questions: { question: string, options: { text: string, correct: boolean }[] }[] }> = {
  [UserLevel.PRESCRIPTOR]: {
    ...
    questions: [
      {
        question: "¿Cuál es el objetivo principal del colaborador?",
        options: [
          { text: "Cerrar ventas directamente", correct: false },
          { text: "Negociar condiciones comerciales", correct: false },
          { text: "Explicar el valor de RedesComerciales.ai y detectar oportunidades", correct: true }
        ]
      },
      {
        question: "¿Qué debe evitar el colaborador al hablar con un contacto?",
        options: [
          { text: "Ser honesto", correct: false },
          { text: "Crear expectativas irreales", correct: true },
          { text: "Explicar el valor tecnológico", correct: false }
        ]
      },
      {
        question: "¿Qué debe transmitir sobre el funcionamiento de RedesComerciales.ai?",
        options: [
          { text: "Que garantiza ventas automáticas", correct: false },
          { text: "Que garantiza el éxito sin esfuerzo", correct: false },
          { text: "Que facilita el crecimiento comercial mediante tecnología", correct: true }
        ]
      }
    ]
  },
          ...
          <div className="max-w-2xl mx-auto px-4 py-12 text-center animate-fade-in">
              ...
              <div className={`p-10 md:p-16 rounded-[3rem] shadow-xl border-2 ${passed ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'}`}>
                  ...
                  <p className="text-gray-600 mb-10 font-bold leading-relaxed">
                      {passed 
                        ? `Excelente. Has aprendido a comunicar el valor de RedesComerciales.ai de forma profesional.`
                        : `Parece que hay dudas sobre cómo comunicar el valor de RedesComerciales.ai. Repasa los puntos clave para asegurar un mensaje coherente.`}
                  </p>
